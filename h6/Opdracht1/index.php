...
$users = [
    ...
    "truushendricks@wegweg" => "arkiearkie201",
];
...
<head>
    <meta charset="UTF-8">
    <meta name="viewpoint"
          content="width=device-width, user-scalab=no, initial-scale=1.0, maxium-scale=1.0, minium-scale=1.0">
...
<?php
if (!isset($_SESSION['error']) or empty($_POST['mailadres'])) {
    echo '<div class="error">' . $_SESSION['error'] . "</div>";
    $_SESSION['error'] = null;
} else {

    if (!isset($_POST['mailadres']) or empty($_POST['mailadres'])) {
        $_SESSION['error'] = "Je bent je mailadres in te vullen.";
